                ...
                <div className={styles.faqContent}>
                    ...
                    <div className={styles.faqItems}>
                        <div className={styles.faqItem}>
                            ...
                            >
                                ...
                                <svg
                                    className={`${styles.dropdownArrow} ${openFAQ === 0 ? styles.dropdownArrowOpen : ""}`}
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
                            ...
                            <div
                                className={`${styles.faqAnswer} ${openFAQ === 0 ? styles.faqAnswerVisible : styles.faqAnswerHidden}`}
                            >
                                <Typography
                                    variant="body1"
                                    component="p"
                        ...
                        <div className={styles.faqItem}>
                            ...
                            >
                                ...
                                <svg
                                    className={`${styles.dropdownArrow} ${openFAQ === 1 ? styles.dropdownArrowOpen : ""}`}
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
                            ...
                            <div
                                className={`${styles.faqAnswer} ${openFAQ === 1 ? styles.faqAnswerVisible : styles.faqAnswerHidden}`}
                            >
                                <Typography
                                    variant="body1"
                                    component="p"
                        ...
                        <div className={styles.faqItem}>
                            ...
                            >
                                ...
                                <svg
                                    className={`${styles.dropdownArrow} ${openFAQ === 2 ? styles.dropdownArrowOpen : ""}`}
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
                            ...
                            <div
                                className={`${styles.faqAnswer} ${openFAQ === 2 ? styles.faqAnswerVisible : styles.faqAnswerHidden}`}
                            >
                                <Typography
                                    variant="body1"
                                    component="p"
                    ...
                    <div className={styles.faqFooterContent}>
                        ...
                        <form
                            ...
                            className={styles.footerSubscribeForm}
                        >
                            <input
                                type="email"
                                value={email}
