    ...
    return (
        <section className={styles.eventInfo}>
            ...
            <div className={styles.textWrapper}>
                ...
                <h3>Discord <img className={styles.outgoingLinkIcon} src={DISCORD} onClick={() => alert('Our Discord server will be open to join between February 13th and February 24th :)')}/></h3>
