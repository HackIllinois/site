...
const OlympianButton: React.FC<OlympianButtonProps> = ({
    ...
    const buttonStyles = {
        background: "linear-gradient(135deg, #E8C4A0 0%, #D9A97A 50%, #C9935D 100%)",
        color: "#000",
        ...
        "&:hover": {
            background: "linear-gradient(135deg, #F0D1B3 0%, #E8C4A0 50%, #D9A97A 100%)",
    ...
    return <Button sx={buttonStyles} onClick={onClick}>{text}</Button>;
};
