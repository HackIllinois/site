        ...
        <div className={styles.container}>
            <div className={styles.content}>
                <div className={styles.block}>
                    ...
                    <div className={styles.compact}>
                        <p className={styles.text}>
                            ...
                            HackIllinois 2024 as a Knight! Since Knights is a
                            cohort for advanced hackers, here is a simple
                ...
                <div className={styles.block}>
                    ...
                    <ol className={`${styles.compact}`}>
                        <li className={styles.listItem}>
                            Click this button to retrieve your JWT token. You
                            must use the same GitHub account you used to
                        ...
                        <li className={styles.listItem}>
                            <div className={styles.compact}>
                                ...
                                <p>
                                    ...
                                    , representing connections between a pair of
                                    nodes that make an undirected graph. You are
                                    also given a dictionary,{" "}
                                    <span className={styles.colouredText}>
                                        nodes
                                    </span>
                                    , containing information about the values
                                ...
                                <p>
                                    ...
                                    in each connected component in the provided
                                    graph.
                                </p>
                                <p>
                                    The solution to the problems is the greatest{" "}
                                    <span className={styles.colouredText}>
                                        total_value
                                    </span>{" "}
                                    of all the sums of each connected component.
                                </p>
                            </div>
                        </li>
                        <li className={styles.listItem}>
                        ...
                        <li className={styles.listItem}>
                            ...
                            this endpoint. Make sure you include your calculated{" "}
                            <span className={styles.colouredText}>
                ...
                <div className={styles.exampleGraph}>
                    ...
                    <div className={styles.compact}>
                        <p>
                            Given that the provided graph looks like this, we
                            have two connected components:{" "}
                            <span className={styles.colouredText}>ace</span> and
                ...
                <div className={styles.block}>
                    ...
                    <ul>
                        ...
                        <li>
                            Your JWT token will never expire so there is no time
                            limit to complete the challenge.
                        </li>
                    </ul>
                </div>
                <div className={styles.block}>
                    ...
                    <ul>
                        <li>
                            We will take into consideration the number of times
                            you submit your solution to ensure no brute force
                            methods are used to solve this challenge.{" "}
                            <b>
                                There are virtually unlimited attempts, but use
                                your submissions wisely
                            </b>
                            .
                        </li>
                        <li>
                            Feel free to use any resources, but your work must
                            be your own.{" "}
                        ...
                        <li>
                            ...
                            guarantee admission as a Knight, it only qualifies
                            you to apply as a Knight.
                        </li>
                    </ul>
                </div>
                <div className={styles.block}>
                    ...
                    <ul>
                        ...
                        <li>
                            Feel free to email us if you have issues with the
                            coding challenge! Please direct your email to{" "}
